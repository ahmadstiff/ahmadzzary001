      ...
      <div class="row gx-5 align-items-center">
        <div class="col-xxl-5">
          ...
          <div class="text-center text-xxl-start">
            <div class="text-white mb-4"><div class="text-uppercase">Student &middot; Web Enthusiast</div></div>
            <div class="fs-3 fw-light text-muted">Hello There!🖐🏽</div>
            <h1 class="display-3 fw-bolder mb-5">I'm <span class="text-gradient d-inline">Ahmad Aroyanu</span></h1>
